...
-(void)camera:(UIViewController*)ViewController{
    ...
    [self.viewVC presentViewController:picker animated:YES completion:nil];
}
...
-(void)updateLogo:(UIViewController *)ViewController {
    ...
    [self.viewVC presentViewController:pickerImage animated:YES completion:^{
...
//        [fileManager createFileAtPath:[DocumentsPath stringByAppendingString:@"/image.png"] contents:data attributes:nil];
        ...
        [picker dismissViewControllerAnimated:YES completion:^{
            UIView *view=[weakSelf.viewVC.view  viewWithTag:100];
...
- (void)showAlert {
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"温馨提示" message:@"请在iPhone的'设置-隐私-照片'选项中,允许云智充访问您手机相机" preferredStyle:UIAlertControllerStyleAlert];
