...
- (IBAction)clickShareBtn:(UIButton *)sender {
    ...
    if (sender.tag == 100) {
        // 微信好友
//        [WFShareHelpTool shareWechatWithWebpageUrl:self.shareUrl title:self.title description:self.desc thumbImage:self.imgView.image scnce:0];
    }else if (sender.tag == 200) {
        //微信朋友圈
//        [WFShareHelpTool shareWechatWithWebpageUrl:self.shareUrl title:self.title description:self.desc thumbImage:self.imgView.image scnce:1];
    }
}
...
- (void)setDict:(NSDictionary *)dict {
    ...
    [self.imgView sd_setImageWithURL:[NSURL URLWithString:self.imgURL] placeholderImage:[UIImage imageNamed:@"IconCode"]];
}
